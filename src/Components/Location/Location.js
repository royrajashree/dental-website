            ...
            <div className="row">
                <div className="col-md-6">
                    <Map
                        google={props.google}
                        zoom={13}
                        style={{ width: "80%", marginLeft: "10vw", marginBottom: '400px', height: '75vh' }}
                        initialCenter={{ lat: 19.223468807494807, lng: 72.85724841170718 }}
                    >
                        <Marker position={{ lat: 19.223468807494807, lng: 72.85724841170718 }} />
                    </Map>
                </div>
                <div className="col-md-6 col-sm-12 d-flex justify-content-center align-items-center" style={{ marginTop: "85vh" }}>
                    <div>
                        <ScrollAnimation animateIn="animate__animated animate__slideInUp">
                            <h3 className="aboutName">LOCATION</h3>
                            <ul style={{ marginTop: "24px" }}>
