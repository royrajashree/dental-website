...
const AboutIntro = () => {
    if (window.innerWidth > 900) {
        return (
            <div style={{ marginTop: "85vh", height: "600px" }}>
                <div className="row">
                    <div className="col-md-5 col-sm-12 d-flex justify-content-center" style={{ marginTop: "200px" }}>
                        <img src={process.env.PUBLIC_URL + 'assets/images/about.jpg'} width="400" height="400" style={{ borderRadius: "50%" }} />
                    </div>
                    <div className="col-md-7 col-sm-12 d-flex justify-content-center align-items-center" style={{ marginTop: "150px" }}>
                        <div>
        ...
        return (
            <div style={{ marginTop: "15vh", height: "600px" }}>
                <div className="row">
                    <div className="col-md-5 col-sm-12 d-flex justify-content-center">
                        <img src={process.env.PUBLIC_URL + 'assets/images/about.jpg'} width="400" height="400" style={{ borderRadius: "50%" }} />
                    </div>
                    <div className="col-md-7 col-sm-12 d-flex justify-content-center align-items-center" style={{ marginTop: "50px" }}>
                        <div>
                            <ScrollAnimation animateIn="animate__animated animate__slideInUp">
                                <h3 className="aboutName">DR. ANAND MOHATTA</h3>
                            </ScrollAnimation>
                            ...
                            <HashRouter>
                                <Link to="/about">
                                    <button className="knowMoreBtn" style={{ transform: "translateX(130%)" }}>KNOW MORE</button>
                                </Link>
                            </HashRouter>
                        </div>
                    </div>
